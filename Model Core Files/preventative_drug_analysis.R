...
for (ii in 1:chunks) {
  ...
  if(PSA==0){
    save(results,file = paste("Drug_results/Determ_",screen_strategy,"_",ii,".Rdata",sep = ""))}else{
      save(results,file = paste("PSA_drug_results/PSA_",screen_strategy,"_",ii,".Rdata",sep = "")) 
    }
