create_sample<-function(PSA=0,intervals=0,seed=1,screen_strategy){
  ...
  PSA_log_norm_mean <- rnorm(mcruns,PSA_log_norm_mean[1],PSA_log_norm_mean[2])
...
#Chemoprevention drug parameters
  ...
  PSA_cost_follow_up<-rnorm(mcruns,PSA_cost_follow_up[1],PSA_cost_follow_up[2])
...
#Generate utility values
  ...
  PSA_gamma_survival<-data.frame(runif(mcruns,PSA_gamma_survival1[1],PSA_gamma_survival1[2]),
                                 runif(mcruns,PSA_gamma_survival2[1],PSA_gamma_survival2[2]),
                                 runif(mcruns,PSA_gamma_survival3[1],PSA_gamma_survival3[2]))
  PSA_meta_survival<-data.frame(runif(mcruns,PSA_meta_survival1[1],PSA_meta_survival1[2]),
  ...
  PSA_util<-data.frame(runif(mcruns,PSA_util_1[1],PSA_util_1[2]),
